...
public class DemandeValidationConsoTempsAccPers {
	 ...
	 *            <ul>
	 *            <li>8192 - demande créée par l'élève</li>
	 ...
	 * @throws DVCTAPException si dctap non crée, dctap en etat final, ou si elle a deja ete mise a jour par un professeur
	 * 
	 */
	 ...
	 * @throws DVCTAPException si dvctap non crée, dvctap en etat final, ou si elle a deja ete mise a jour par un professeur
	 * 
	 */
	...
	/**
	 * Refusée par l'eleve
	 * @throws DVCTAPException si dctap non crée, dctap en etat final,et si elle a deja ete mise a jour par un professeur
	 * 
	 */
	 ...
	 * @return booleen qui retourne si état a été modifiée par prof (durée, AP, date)
	 */
	...
	/**
	 * teste si etat est final,c'est a dire qu'il ne peut plus supporter de modifications
	 * il teste si il a été annulé par l'eleve,refusé par l'eleve,refusé par le prof,validé par l'eleve, ou validé par le prof
